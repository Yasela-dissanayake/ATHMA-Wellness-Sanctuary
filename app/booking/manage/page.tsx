        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4">
            ...
            <p className="text-stone-600 max-w-2xl mx-auto">
              View, modify, or cancel your hypnotherapy appointments. Need help?
              Contact us anytime.
            </p>
          </div>
        </div>
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-stone-600">
                  Enter your email address or booking ID to view and manage your
                  appointments.
                </p>
              </CardHeader>
                          ...
                          <DialogContent>
                            <DialogHeader>
                              ...
                              <DialogDescription>
                                ...
                                Changes must be made at least 24 hours in
                                advance.
                              </DialogDescription>
                            </DialogHeader>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center space-y-4 mb-8">
              ...
              <p className="text-stone-600">
                Our team is here to help with any booking questions or concerns.
              </p>
            </div>
