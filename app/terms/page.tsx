      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="mb-8">
            ...
            <CardContent className="space-y-4">
              <p className="text-gray-700">
                By accessing and using the ATHMA Wellness Sanctuary website and
          ...
          <Card className="mb-8">
            ...
            <CardContent className="space-y-4">
              <p className="text-gray-700">
                ATHMA Wellness Sanctuary provides professional hypnotherapy services
          ...
          <Card className="mb-8">
            ...
            <CardContent className="space-y-4">
              <p className="text-gray-700">
                ATHMA Wellness Sanctuary shall not be liable for any indirect,
