        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <p className="text-lg text-stone-600 leading-relaxed">
              Discover how Angela's holistic healing approach has helped
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-stone-600 max-w-2xl mx-auto">
              ...
              healing through Angela's diverse range of therapeutic modalities.
            </p>
          </div>
      ...
      <section className="py-20 bg-stone-50">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-stone-600 max-w-2xl mx-auto">
              From Dubai to Australia and beyond, Angela's healing work has
      ...
      <section className="py-20 bg-sage-600 text-white">
        <div className="container mx-auto px-4 text-center space-y-8">
          ...
          <p className="text-sage-100 max-w-2xl mx-auto">
            ...
            healing through Angela's holistic approach. Your journey to
